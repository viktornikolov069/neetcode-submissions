class CurrencyConverter:
    ...
    @staticmethod
    def to_usd(ammount: int, cur_code: str) -> int:
        return CurrencyConverter.rates[cur_code] * ammount

    @classmethod
    def to_usd(cls, ammount: int, cur_code: str) -> int:
        return cls.rates[cur_code] * ammount
